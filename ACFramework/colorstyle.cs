...
namespace ACFramework
{
    class cColorStyle
    {
        ...
        /// </summary>
        /// <param name="mutationflags">A collection of bits -- to enable color mutation, do a bit-wise or with cPolygon.MF_COLOR,
        /// to enable fill mutation, to a bit-wise or with cPolygon.MF_FILLING, and to enable linewidth mutation, do a 
        /// bit-wise or with cPolygon.MF_LINEWIDTH.</param>
        ...
        public void mutate(int mutationflags, float mutationstrength)
        {
            ...
            //The linewidth 
            if ((mutationflags & cPolygon.MF_LINEWIDTH) != 0)
            {
